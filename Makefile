...
FUSE_L  = 0x7F# see below for fuse values for particular devices
FUSE_H  = 0x81
...
OBJECTS = TWI_Master.o eeprom.o util.o leds.o usbdrv/usbdrv.o usbdrv/usbdrvasm.o usb.o main.o 
